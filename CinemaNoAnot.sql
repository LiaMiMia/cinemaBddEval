...
VALUES  ("ecae02d2974f11edb766e8f1002ad19a", "Customer"), ("ecae02e6974f11edb766e8f1002ad19a", "Cashier");
...
drop database eval_em_cinema;
use mysql; 
delete from user where user = 'ComplexeManager1';
delete from user where user = 'ComplexeManager2';
delete from user where user = 'ComplexeManager3';
delete from user where user = 'ComplexeManager4';
delete from user where user = 'ComplexeManager5';
delete from user where user = 'OnlineCustomer';
delete from user where user = 'SuperAdmin';

drop user 'ComplexManager1'@'locahost';
drop user 'ComplexManager2'@'locahost';
drop user 'ComplexManager3'@'locahost';
drop user 'ComplexManager4'@'locahost';
drop user 'ComplexManager5'@'locahost';

drop user 'ComplexManager1'@'locahost';
drop user 'SuperAdmin'@'locahost';
drop user 'OnlineCustomer'@'locahost';